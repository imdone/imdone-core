...
function mixin(repo, fs) {
  ...
  repo.loadConfig = function(cb) {
    // #ARCHIVE:50 Fix loadConfig defaults id:1215
    // TODO:40 assigned:piascikj If a config is bad move it to config.json.bak and save a new one with defaults +enhancement +standup gh-iss:2 id:1216
    cb = tools.cb(cb);
    repo.loadIgnore();
  ...
  // #ARCHIVE:70 Allow (all) param to not check ignores id:1217
  ...
  // #ARCHIVE:130 Make getFileTree async id:1218
