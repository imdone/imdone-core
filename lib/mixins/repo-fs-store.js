...
function mixin(repo, fs) {
  ...
  repo.loadConfig = function(cb) {
    // TODO:50 If a config is bad move it to config.json.bak and save a new one with defaults gh:2 id:9 +enhancement +standup +chore
    cb = tools.cb(cb);
    repo.loadIgnore();
    var file = repo.getFullPath(CONFIG_FILE);
  ...
  repo.getTemplates = function(qry, cb) {
    ...
    // TODO:60 Implement getTemplates id:39 gh:143 ic:gh
    //  - [ ] Test
  };
