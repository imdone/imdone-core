...
File.prototype.getCodeCommentRegex = function() {
  // #TODO:10 Allow languages to have multiple block comment styles, like html gh-iss:13
  var lang = this.getLang();
...
File.prototype.modifyCodeOrHashTask = function(re, task) {
  ...
  if (result) {
    ...
    // DOING: Create a temporary task from the taskText so we can parse the meta:id for comparison as another option
