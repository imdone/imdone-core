...
// TODO:10 Add GFM style tasks with [todotext project](https://github.com/todotxt/todo.txt#project) is the list name id:2 gh:90
...
// DOING:300 This is adding spaces where they shouldn't be. gh:199 id:61
...
File.prototype.getCodeCommentRegex = function() {
  // #TODO:200 Allow languages to have multiple block comment styles, like html gh:13 id:5
  var lang = this.getLang();
...
File.prototype.hasTaskInText = function(config, text) {
  // TODO:80 Make sure the tag is in our list of tags before we call it a task id:27 gh:121
...
File.prototype.extractTasksInNonCodeFile = function(config) {
  // TODO:20 As a user I would like imdone to recognize code style tasks in markdown file comments id:38 gh:140 ic:gh
...
File.prototype.modifyCodeOrHashTask = function(re, task, config) {
  ...
  while ((result = re.exec(this.getContent())) !== null) {
    ...
    if (this.tasksMatch(task, line, taskText)) {
      ...
      // DOING:280 Fix issue with single line block comments id:41 gh:168
