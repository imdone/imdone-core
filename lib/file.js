...
// [Implement #listname style tasks in any text file](#ARCHIVE:90)
// [Allow code style tasks to be included on list name](#ARCHIVE:80)
/**
 * Description
 * @method extractTasks
 * @return ThisExpression
 */
// #DONE:30 Have a seperate extract and modify method for code files and only look in comments and block comments
