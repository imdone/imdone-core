...
File.prototype.setContentFromFile = function(content) {
  // DONE: call hasWindowsEOL and store as property of file
  // - [x] Normalize EOL as \n
...
File.prototype.getContentForFile = function() {
  // DONE: normalize line endings
  // - [x] if hasWindowsEOL use eol.auto(content) otherwise use eol.lf
