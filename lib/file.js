...
File.prototype.getCommentsAfterLine = function({config, content, inCodeBlock, beforeText}) {
  ...
  for(let i=1; i < lines.length; i++) {
    ...
    // TODO:1.875 In markdown, hold on to blank lines until we find:
    // - end of task `<!-- multiline:true -->
    // - If multiline found, keep line feeds
    // - If new task or end of file found, then only keep up to the first line feed
  }
