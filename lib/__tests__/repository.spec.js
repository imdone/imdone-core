...
import { WorkerProject as Project } from '../project.js'
...
import { fileSystemStoreMixin as fsStore } from '../mixins/repo-fs-store.js'
...
- description line 2`
  ...
  describe('It should allow : or :: in config.settings.metaSep', function () {
    it('should read metaData with a :: as sep', async () => {
      ...
      await metaSepTestRepo.loadConfig();
      metaSepTestRepo.config.archiveCompleted = false;
