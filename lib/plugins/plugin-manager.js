...
const { getAvailablePlugins } = require('./plugin-registry')  
const { exists, mkdir } = require('../adapters/file-gateway')
...
module.exports = class PluginManager extends Emitter {
  ...
  async loadPlugins() {
    ...
    // DOING: read plugins from config settings and install them if they don't exist
  ...
  // READY Make getBoardProperties async
  // <!--
  // order:-10
  // -->
