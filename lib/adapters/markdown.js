...
export const allEmoji = createRequire(import.meta.url)('markdown-it-emoji/lib/data/full.json')

let _platform = process.platform

export function extractWikilinkTopics(markdown) {
