...
// [Need a way to run only one operation at a time on a project or repo. Use [kue](https://www.npmjs.org/package/kue)](#ARCHIVE:200)
// [Decide which listeners we should expose at the project level](#ARCHIVE:260)
// [We should have a destroy method](#ARCHIVE:300)
...
Project.prototype.createListeners = function() {
  ...
  // [Add file.update and file.delete listener for repos and emit project.modified](#ARCHIVE:220)
  /**
   * Description
  ...
  this.fileUpdateListener = function(file) {
    // [fix emit modified by saving these up and emitting only if a backlog exists](#ARCHIVE:270)
...
// [Use async file operations](#ARCHIVE:210)
// [Only save config if there is more than one repo](#ARCHIVE:290)
/**
 * Description
 * @method saveConfig
 * @param {} cb
...
// [Implement addRepo and removeRepo](#ARCHIVE:230)
/**
 * Description
 * @method removeRepo
 * @param {} repoId
...
Project.prototype.moveList = function(name, pos, cb) {
  ...
  // [Fix all empty cb to return error](#ARCHIVE:250)
};
...
function moveTask(project, task, newList, newPos, cb) {
  // #ARCHIVE:110 repo.modifyTask takes a callback
...
// [User should be able to add a list to a project](#ARCHIVE:180)
/**
 * Description
 * @method addList
 * @param {} name
...
// [getFilesTree should return a nested list of files](#ARCHIVE:190)
/**
 * Description
 * @method getFileTree
 * @param {} repoId
