...
// TODO:30 Need a way to run only one operation at a time on a project or repo. Use [kue](https://www.npmjs.org/package/kue)
// TODO:40 Decide which listeners we should expose at the project level
// TODO:50 We should have a destroy method
...
Project.prototype.createListeners = function() {
  ...
  // DOING:0 Add file.update and file.delete listener for repos and emit project.modified
  /**
   * Description
  ...
  this.fileUpdateListener = function(file) {
    // DONE:10 fix emit modified by saving these up and emitting only if a backlog exists
...
// DONE:50 Use async file operations
/**
 * Description
 * @method saveConfig
 * @param {} cb
...
// DONE:20 Implement addRepo and removeRepo
/**
 * Description
 * @method removeRepo
 * @param {} repoId
...
// DONE:0 getFilesTree should return a nested list of files
/**
 * Description
 * @method getFileTree
 * @param {} repoId
