...
// [Need a way to run only one operation at a time on a project or repo. Use [kue](https://www.npmjs.org/package/kue)](#ARCHIVE:)
// [Decide which listeners we should expose at the project level](#ARCHIVE:)
// [We should have a destroy method](#ARCHIVE:)
...
Project.prototype.createListeners = function() {
  ...
  // [Add file.update and file.delete listener for repos and emit project.modified](#ARCHIVE:)
  /**
   * Description
  ...
  this.fileUpdateListener = function(file) {
    // [fix emit modified by saving these up and emitting only if a backlog exists](#ARCHIVE:)
...
// [Use async file operations](#ARCHIVE:)
// [Only save config if there is more than one repo](#ARCHIVE:)
/**
 * Description
 * @method saveConfig
 * @param {} cb
...
// [Implement addRepo and removeRepo](#ARCHIVE:)
/**
 * Description
 * @method removeRepo
 * @param {} repoId
...
Project.prototype.moveList = function(name, pos, cb) {
  ...
  // [Fix all empty cb to return error](#ARCHIVE:)
};
...
function moveTask(project, task, newList, newPos, cb) {
  // #ARCHIVE: repo.modifyTask takes a callback
...
// [User should be able to add a list to a project](#ARCHIVE:)
/**
 * Description
 * @method addList
 * @param {} name
...
// [getFilesTree should return a nested list of files](#ARCHIVE:)
/**
 * Description
 * @method getFileTree
 * @param {} repoId
