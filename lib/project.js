...
// emits list.rename, list.found, list.moved, tasks.moved, project.modified
...
Project.prototype.getFile = function(repoId, path) {
  var repo = this.getRepo(repoId);
  return repo ? repo.getFile(path) : undefined;
};
