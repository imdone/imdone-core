...
Project.prototype.createListeners = function() {
  ...
  // DONE:30 Add file.update and file.delete listener for repos and emit project.modified
  /**
   * Description
  ...
  this.fileUpdateListener = function(file) {
    // DONE:60 fix emit modified by saving these up and emitting only if a backlog exists
...
// DONE:100 Use async file operations
// DONE:40 Only save config if there is more than one repo
/**
 * Description
 * @method saveConfig
 * @param {} cb
...
// DONE:70 Implement addRepo and removeRepo
/**
 * Description
 * @method removeRepo
 * @param {} repoId
...
// DONE:50 getFilesTree should return a nested list of files
/**
 * Description
 * @method getFileTree
 * @param {} repoId
