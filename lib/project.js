...
// [Need a way to run only one operation at a time on a project or repo. Use [kue](https://www.npmjs.org/package/kue)](#ARCHIVE:130)
// [Decide which listeners we should expose at the project level](#ARCHIVE:190)
// [We should have a destroy method](#ARCHIVE:230)
...
Project.prototype.createListeners = function() {
  ...
  // [Add file.update and file.delete listener for repos and emit project.modified](#ARCHIVE:150)
  /**
   * Description
  ...
  this.fileUpdateListener = function(file) {
    // [fix emit modified by saving these up and emitting only if a backlog exists](#ARCHIVE:200)
...
// [Use async file operations](#ARCHIVE:140)
// [Only save config if there is more than one repo](#ARCHIVE:220)
/**
 * Description
 * @method saveConfig
 * @param {} cb
...
// [Implement addRepo and removeRepo](#ARCHIVE:160)
/**
 * Description
 * @method removeRepo
 * @param {} repoId
...
Project.prototype.moveList = function(name, pos, cb) {
  ...
  // [Fix all empty cb to return error](#ARCHIVE:180)
};
...
function moveTask(project, task, newList, newPos, cb) {
  // #ARCHIVE:40 repo.modifyTask takes a callback
...
// [getFilesTree should return a nested list of files](#ARCHIVE:120)
/**
 * Description
 * @method getFileTree
 * @param {} repoId
