...
// [Need a way to run only one operation at a time on a project or repo. Use [kue](https://www.npmjs.org/package/kue) id:19](#ARCHIVE:200)
// [Decide which listeners we should expose at the project level id:20](#ARCHIVE:260)
// [We should have a destroy method id:21](#ARCHIVE:300)
...
Project.prototype.createListeners = function() {
  ...
  // [Add file.update and file.delete listener for repos and emit project.modified id:22](#ARCHIVE:220)
  /**
   * Description
  ...
  this.fileUpdateListener = function(file) {
    // [fix emit modified by saving these up and emitting only if a backlog exists id:23](#ARCHIVE:270)
...
// [Use async file operations id:24](#ARCHIVE:210)
// [Only save config if there is more than one repo id:25](#ARCHIVE:290)
/**
 * Description
 * @method saveConfig
 * @param {} cb
...
// [Implement addRepo and removeRepo id:26](#ARCHIVE:230)
/**
 * Description
 * @method removeRepo
 * @param {} repoId
...
Project.prototype.moveList = function(name, pos, cb) {
  ...
  // [Fix all empty cb to return error id:27](#ARCHIVE:250)
};
...
function moveTask(project, task, newList, newPos, cb) {
  // #ARCHIVE:110 repo.modifyTask takes a callback id:28
...
// [Test moveTasks id:29](#ARCHIVE:240)
/**
 * Description
 * @method moveTasks
 * @param {} tasks
...
// [User should be able to add a list to a project id:30](#ARCHIVE:180)
/**
 * Description
 * @method addList
 * @param {} name
...
// [getFilesTree should return a nested list of files id:31](#ARCHIVE:190)
/**
 * Description
 * @method getFileTree
 * @param {} repoId
