...
CliController.addTask = async function ({task, projectPath = defaultProjectPath, storyId, list, group, tags=[], contexts=[], defaults, log}) {
  ...
  await storyProject.addTaskToFile({list, tags: ['task', ...tags], content: task, meta, contexts})
