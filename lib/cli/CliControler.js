...
require('./domain/adapters/ApplicationContext')()
...
const TASK_ID = BacklogProject.constants.TASK_ID
const UNGROUPED_TASKS = BacklogProject.constants.UNGROUPED_TASKS
...
CliController.completeTask = async function (log) {
  consoleLog = log
  storyId = await determineStoryId(null, true)
