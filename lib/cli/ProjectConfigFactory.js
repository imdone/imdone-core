...
const BACKLOG_CONFIG_PATH = path.join(__dirname, '..', '..', 'devops', 'imdone', 'backlog-config.yml')
const STORY_CONFIG_PATH = path.join(__dirname, '..', '..', 'devops', 'imdone', 'story-config.yml')
