...
// TODO:40 Emit file.saved for individual files being saved then update checksum in writeFile id:12 gh:97
...
Repository.prototype.renameList = function(oldName, newName, cb) {
  ...
  // TODO:70 Let's use saveModifiedFiles here id:15 gh:100 +fix
...
Repository.prototype.saveWorkflow = function(name, cb) {
  ...
  // TODO:130 saveConfig id:33 gh:135 ic:gh

};

Repository.prototype.deleteWorkflow = function(name, cb) {
  // TODO:100 implement deleteWorkflow id:35 gh:137 ic:gh

};

Repository.prototype.applyWorkflow = function(name) {
  // TODO:90 implement applyWorkflow id:37 gh:139 ic:gh
...
Repository.prototype.query = function(queryString) {
  let result = Repository.query(this.getTasks(), queryString)
  if (result.length === 0) {
    result = this.getTasks().filter(task => {
