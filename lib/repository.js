...
// DOING:0 Emit file.saved for individual files being saved then update checksum in writeFile id:32
...
// [Make sure lists are not saved on load in alphabetical order id:33](#ARCHIVE:170)
/**
 ...
 * @return CallExpression
 */
// #ARCHIVE:80 Make all calls to getFilesInPath async id:34
...
// [Test renameList id:35](#ARCHIVE:280)
/**
 * Description
 * @method renameList
 * @param {} oldName
...
Repository.prototype.renameList = function(oldName, newName, cb) {
  ...
  // DOING:20 Let's use saveModifiedFiles here id:36
  if (funcs.length > 0) {
...
// #ARCHIVE:100 modifyTask must be async.  Get file content before proceeding. id:37
/**
 * Description
 * @method modifyTask
 * @param {} task
...
// #ARCHIVE:120 Implement moveTasks id:38
Repository.prototype.moveTasks = function(tasks, newList, newPos, noEmit, cb) {
  ...
  if (_.isFunction(noEmit)) cb = noEmit, noEmit = false;
  this.moving = true;
  cb = tools.cb(cb);
