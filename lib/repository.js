...
var _isFunction = require('lodash.isfunction'),
  ...
  { getRawTask, isNumber, LIST_NAME_PATTERN } = require('./adapters/parsers/task/CardContentParser'),
 ...
 * @return
 */
Repository.prototype.addList = async function (list, cb) {
  cb = tools.cb(cb);
...
Repository.prototype.shouldInclude = function (relPath) {
  ...
  if (include) console.log('Including file:', relPath)
  return include
}
...
/**
 * Pause file watching (Implemented in mixins)
 * @method pause
 * @return Promise
 */
Repository.prototype.pause = async function () {
  return Promise.resolve()
}

/**
 * Resume file watching (Implemented in mixins)
 * @method resume
 * @return Promise
 */
Repository.prototype.resume = async function () {
  return Promise.resolve()
}

/**
 * Check if file watching is paused (Implemented in mixins)
 * @method isPaused
 * @return Boolean
 */
Repository.prototype.isPaused = function () {
  return false
}
...
Repository.prototype.getListById = function(id, lists = this.getLists()) {
...
Repository.prototype.toggleListIgnore = async function (name) {
...
Repository.prototype.toggleList = async function (name) {
  return new Promise(async (resolve, reject) => {
    var self = this
    var list = this.getList(name)
    if (!list) return reject(new Error('List not found'))
...
Repository.prototype.updateList = function(id, {name, hidden, ignore, filter}) {
  return new Promise((resolve, reject) => {
...
Repository.parseHideListsFromQueryString = function (queryString) {
  const hideLists = []
