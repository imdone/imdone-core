...
Repository.prototype.getFiles = function() {
  return this.files;
};
...
Repository.prototype.removeFile = function(id) {
  if (!File.isFile(file)) throw new Error(NOT_A_FILE);
  this.files = _.reject(this.files, {id:id});
  return this.files;
};

Repository.prototype.getFile = function(id) {
  return _.where(this.files, {id:id});
};
...
Repository.prototype.deleteFile = function(id) {
