...
Task.prototype.updateTags = function() {
  ...
  // DOING:10 We should also remove stuff
};

Task.prototype.updateContext = function() {
  // DOING:40 implement updateContext
  var self = this;
  ...
  // DOING:20 We should also remove stuff
};
...
Task.prototype.updateDates = function() {
  // DOING:0 Implement updateDates includeing due
};
