...
Task.prototype.updateTags = function() {
  ...
  // DOING:30 We should also remove stuff
};

Task.prototype.updateContext = function() {
  // DOING:60 implement updateContext
  var self = this;
  ...
  // DOING:40 We should also remove stuff
};

Task.prototype.updateMetaData = function() {
  // READY:10 implement updateMetaData
  var self = this;
  ...
  // DOING:50 We should also remove stuff
};

Task.prototype.updateDates = function() {
  // DOING:10 Implement updateDates includeing due
};
