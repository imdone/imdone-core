...
//#ARCHIVE: This is where we should look for tags /\s\+(\w*)/gi; and context /\s\@(\w*)/gi; +feature undefined:55
Task.prototype.parseTodoTxt = function() {
  // TODO: #hashtags should be treated like todo.txt tags
...
Task.prototype.updateTags = function() {
  ...
  // DOING: We should also remove stuff
};

Task.prototype.updateContext = function() {
  // DOING: implement updateContext
  var self = this;
...
Task.prototype.updateMetaData = function() {
  ...
  // DOING: We should also remove stuff to allow removal of id's when deactivating
  if (metaFromText) {
...
Task.prototype.updateDates = function() {
  // DOING: Implement updateDates includeing due
};
