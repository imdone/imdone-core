...
//#ARCHIVE:30 This is where we should look for tags /\s\+(\w*)/gi; and context /\s\@(\w*)/gi; +feature id:40
Task.prototype.parseTodoTxt = function() {
  // TODO:0 #hashtags should be treated like todo.txt tags id:41
...
Task.prototype.updateTags = function() {
  // DOING:70 implement updateTags id:42
  var self = this;
  ...
  // DOING:30 We should also remove stuff id:43
};

Task.prototype.updateContext = function() {
  // DOING:60 implement updateContext id:44
  var self = this;
  ...
  // DOING:40 We should also remove stuff id:45
};

Task.prototype.updateMetaData = function() {
  // READY:10 implement updateMetaData id:46
  var self = this;
  ...
  // DOING:50 We should also remove stuff id:47
};

Task.prototype.updateDates = function() {
  // DOING:10 Implement updateDates includeing due id:48
};
