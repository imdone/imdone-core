...
//#ARCHIVE:30 This is where we should look for tags /\s\+(\w*)/gi; and context /\s\@(\w*)/gi; +feature id:1241
Task.prototype.parseTodoTxt = function() {
  // TODO:0 #hashtags should be treated like todo.txt tags id:1242
...
Task.prototype.updateTags = function() {
  // DOING:70 implement updateTags id:1243
  var self = this;
  ...
  // DOING:30 We should also remove stuff id:1244
};

Task.prototype.updateContext = function() {
  // DOING:60 implement updateContext id:1245
  var self = this;
  ...
  // DOING:40 We should also remove stuff id:1246
};

Task.prototype.updateMetaData = function() {
  // READY:10 implement updateMetaData id:1247
  var self = this;
  var meta = Task.getMetaData(this.text);
  if (this.getMetaData()) {
    _.forEach(this.getMetaData(), function(values, key) {
      if (!meta || !meta[key]) {
  ...
  // DOING:50 We should also remove stuff id:1248
};

Task.prototype.updateDates = function() {
  // DOING:10 Implement updateDates includeing due id:1249
};
