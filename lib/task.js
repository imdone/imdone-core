...
Task.prototype.updateTags = function() {
  // DOING:80 implement updateTags id:42
  var self = this;
  ...
  // DOING:40 We should also remove stuff id:43
};

Task.prototype.updateContext = function() {
  // DOING:70 implement updateContext id:44
  var self = this;
  ...
  // DOING:50 We should also remove stuff id:45
};
...
Task.prototype.updateMetaData = function() {
  ...
  // DOING:0 We should also remove stuff to allow removal of id's when deactivating id:46
  if (metaFromText) {
...
Task.prototype.updateDates = function() {
  // DOING:20 Implement updateDates includeing due id:47
};
