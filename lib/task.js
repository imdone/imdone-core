...
Task.prototype.parseTodoTxt = function() {
  // TODO:0 #hashtags should be treated like todo.txt tags
...
Task.prototype.updateContext = function() {
  // DOING:70 implement updateContext
  var self = this;
...
Task.prototype.updateMetaData = function() {
  ...
  // DOING:0 We should also remove stuff to allow removal of id's when deactivating
  if (metaFromText) {
...
Task.prototype.updateDates = function() {
  // DOING:20 Implement updateDates includeing due
};
