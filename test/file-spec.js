...
describe('File', function() {
  ...
  describe('extractAndTransformTasks', () => {
    ...
    it('should complete tasks with checkbox beforeText in a md file', () => {
      ...
      lines[14].should.equal('- [x] [A card in a checklist](#DONE:0)')
      lines[19].should.equal('- [x] #DONE:0 make sure this is checked')
    ...
    it('should uncomplete tasks with checkbox beforeText in a md file', () => {
      ...
      file.transformTasks(config, true)
      const lines = eol.split(file.content)
      lines[29].should.equal('- [ ] [Make sure this is unchecked](#TODO:0)')
      lines[33].should.equal('- [ ] #TODO:0 Make sure this is unchecked 2')
    ...
    it(`should find checkbox tasks`, () => {
      ...
      lines[0].should.equal('- [ ] [A checkbox task without a list](#TODO:0)')
      lines[10].should.equal('- [ ] [A new checkbox task](#TODO:0)')
      lines[11].should.equal('  - [ ] Another checkbox subtask')
      lines[16].should.equal('- [ ] [Task 1-a](#TODO:0)')
      lines[17].should.equal('  - [ ] Subtask 1-a-a')
      lines[18].should.equal('  - [ ] Subtask 1-a-b')
      lines[22].should.equal('- [ ] [Task 1-b](#TODO:0)')
      lines[23].should.equal('  - [ ] Subtask 1-b-a')
      lines[24].should.equal('  - [ ] Subtask 1-b-b')
      lines[30].should.equal('  - [ ] [A task in a list](#TODO:0)')
    })
  })
